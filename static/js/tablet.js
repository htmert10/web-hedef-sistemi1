...
let stream,socket,corners=[],reference=null,referenceTarget=null,lastScanFrame=null,previousScanFrame=null,noiseFloor=null,knownHoles=[],armed=false,busy=false,pending=null,scanTimer=null,candidateTrack=null,stableScanCount=0,shotQueue=[];
...
$("corners").onclick=()=>{corners=[];reference=null;referenceTarget=null;lastScanFrame=null;previousScanFrame=null;noiseFloor=null;knownHoles=[];candidateTrack=null;stableScanCount=0;armed=false;setAutomaticScanning(false);$("reference").disabled=true;$("arm").disabled=true;$("test").disabled=true;status("Köşeleri yeniden seç.")};
...
async function detect(){
  ...
  try{
    ...
    const required=best.ringRisk?4:best.confidence<.72||!clearContrast?3:2;
    candidateTrack=same?{
