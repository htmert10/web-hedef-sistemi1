...
let stream,socket,corners=[],reference=null,referenceTarget=null,lastScanFrame=null,noiseFloor=null,knownHoles=[],armed=false,busy=false,pending=null,scanTimer=null,candidateTrack=null,shotQueue=[];
...
$("corners").onclick=()=>{corners=[];reference=null;referenceTarget=null;lastScanFrame=null;noiseFloor=null;knownHoles=[];candidateTrack=null;armed=false;setAutomaticScanning(false);$("reference").disabled=true;$("arm").disabled=true;$("test").disabled=true;status("Köşeleri yeniden seç.")};
